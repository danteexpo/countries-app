...
const Filters = ({ setApi }) => {
  return (
    <section className='flex flex-col justify-center items-center relative md:absolute md:right-4'>
      <Menu>
        <Menu.Button className={`bg-mywhite font-semibold text-lg mt-8 shadow-lg py-3 flex justify-around items-center w-56 dark:bg-myblack dark:text-mywhite`}>
          Filter By Region
        ...
        <Menu.Items className={`flex flex-col bg-mywhite shadow-lg w-56 dark:bg-myblack dark:text-mywhite absolute top-20 md:top-20`}>
